...
public class AgrimentTM {
    ...
    public AgrimentTM(String agreement_id, String payment_terms, Date start_date, Date end_date, BigDecimal deposit_amount, BigDecimal total_rent_cost) {
