...
public class VehicleRentDetailTM {
    ...
    public VehicleRentDetailTM(String vehicle_id, String rent_id, Date start_date, Date end_date,  String vehicle_condition, int vehicle_quantity) {
